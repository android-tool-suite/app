...
public final class V2DatasetServiceInstrumentedTest {
    private static final String PLUGIN_ID = "test.runtime_v2_data";
    private Context context;
    private V2RuntimeProcess runtime;

    @Before
    public void setUp() throws Exception {
        context = ApplicationProvider.getApplicationContext();
        runtime = V2RuntimeProcess.get(context);
        if (runtime.packages().find(PLUGIN_ID) != null) runtime.packages().delete(PLUGIN_ID);
        V2PackageStore.InstallSession install = runtime.packages().install(packageBytes(), "test", "", false);
    ...
    public void datasetCommitSecretRoundTripAndFailedValidationPreserveGeneration() throws Exception {
        V2DatasetService service = runtime.datasets();
        ...
        V2MigrationToolPlugin migration = new V2MigrationToolPlugin(
    ...
    public void pureJavaScriptWorkerRunsWithoutWebViewOrMessagePorts() throws Exception {
        V2PackageStore.InstalledPlugin installed = runtime.packages().find(PLUGIN_ID);
        JSONObject result = V2JavaScriptWorkerEngine.run(
                context,
                installed,
    ...
    private static byte[] read(V2DatasetService service, String session, String datasetId) throws Exception {
    ...
    private static byte[] packageBytes() throws Exception {
        JSONObject manifest = new JSONObject()
                ...
                .put("plugin", new JSONObject()
                        .put("id", PLUGIN_ID)
                        .put("title", "Runtime v2 data test")
