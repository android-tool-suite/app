...
public final class V2PluginPermissionInstrumentedTest {
    private static final String PLUGIN_ID = "test.runtime_v2_permissions";
    private Context context;
    private V2PluginPermissionManager permissions;
    ...
    public void persistsGrantAndInvalidatesItWhenScopeExpands() throws Exception {
        ...
        V2PluginPermissionManager reloaded = new V2PluginPermissionManager(context);
    ...
    public void routerRejectsPendingPermissionAndCancelsOnRevoke() throws Exception {
        ...
        permissions.reconcile(manifest);
        V2CapabilityRouter router = new V2CapabilityRouter(new V2BackgroundTaskRegistry(), permissions);
