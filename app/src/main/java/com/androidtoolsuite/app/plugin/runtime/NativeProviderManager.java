...
public final class NativeProviderManager implements AutoCloseable {
    private static final String TAG = "AtsRuntimeProvider";
    private final Context context;
    private final CapabilityRouter router;
    private final BackgroundTaskRegistry backgroundTasks;
    private final PublisherTrustStore trustStore;
    ...
    public NativeProviderManager(
        ...
        this.trustStore = new PublisherTrustStore(this.context);
        this.runtimeRoot = new File(this.context.getCodeCacheDir(), "plugin-runtime-providers");
    }

    public synchronized void loadEnabledAtColdStart(List<PluginPackageStore.InstalledPlugin> installedPlugins) {
    ...
    public synchronized boolean isPendingRestart(PluginPackageStore.InstalledPlugin installed) {
    ...
    private void activate(PluginPackageStore.InstalledPlugin installed)
        ...
        PluginPackageArchive.VerifiedPackage verified = PluginPackageArchive.extract(
        ...
        PluginPackageArchive.sealGeneration(extraction);
    ...
    private static final class ScopedRegistrar implements CapabilityRegistrar {
        ...
        ScopedRegistrar(CapabilityRouter router, BackgroundTaskRegistry backgroundTasks,
    ...
    private static final class ProviderParentClassLoader extends ClassLoader {
        private static final Set<String> ALLOWED_SDK_TYPES = Set.of(
                ...
                com.androidtoolsuite.app.plugin.runtime.BackgroundTaskCall.class.getName(),
