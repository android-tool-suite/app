package com.androidtoolsuite.app.plugins.builtin.shizuku;
...
import com.androidtoolsuite.app.plugins.ComposePluginUiKt;
        ...
        return Collections.singletonList(new HomeWidget() {
            ...
            public List<com.androidtoolsuite.app.plugin.api.HomeWidgetSize> supportedSizes() {
                return java.util.Arrays.asList(
                        ...
                        new com.androidtoolsuite.app.plugin.api.HomeWidgetSize(4, 3)
                );
            }
