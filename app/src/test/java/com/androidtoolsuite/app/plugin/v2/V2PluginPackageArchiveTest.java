...
public class V2PluginPackageArchiveTest {
    @Rule
    ...
    public void extractsVerifiedDeclarativeWebViewPackage() throws Exception {
        ...
        V2PluginPackageArchive.VerifiedPackage verified = V2PluginPackageArchive.extract(packageBytes, target);
    ...
    public void rejectsNativePayloadHiddenInsideOrdinaryTool() throws Exception {
        ...
        ContractException error = assertThrows(
                ...
                () -> V2PluginPackageArchive.extract(
                        packageBytes,
    ...
    public void probesNumericFormatV3WithoutTreatingLegacyStringAsV3() throws Exception {
        ...
        assertTrue(V2PluginPackageArchive.hasFormatV3Manifest(v3));
        assertFalse(V2PluginPackageArchive.hasFormatV3Manifest(legacy));
    }
    ...
    public void rejectsTamperedPayloadAndRemovesStaging() throws Exception {
        ...
        assertThrows(ContractException.class, () -> V2PluginPackageArchive.extract(tampered, target));
    ...
    public void rejectsCaseFoldedDuplicatePaths() throws Exception {
        ...
        assertThrows(
                ContractException.class,
                () -> V2PluginPackageArchive.extract(packageBytes, new File(temporary.getRoot(), "duplicate"))
        );
    }
    ...
    public void rejectsTraversalBeforeWritingOutsideTarget() throws Exception {
        ...
        assertThrows(ContractException.class, () -> V2PluginPackageArchive.extract(packageBytes, target));
