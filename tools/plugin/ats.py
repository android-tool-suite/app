#!/usr/bin/env python3
"""Android Tool Suite 插件运行时 contract, package and code-generation CLI.
...
GENERATED_TS = PACKAGE_ROOT / "web-sdk" / "src" / "generated.ts"
GENERATED_JAVA = (
    PACKAGE_ROOT
    / "runtime-contract"
    / "src"
...
def generated_typescript(index: dict[str, Any], capabilities: list[dict[str, Any]]) -> str:
    ...
    return f"""// Generated by tools/plugin/ats.py generate. Do not edit manually.
...
def parser() -> argparse.ArgumentParser:
    root = argparse.ArgumentParser(prog="ats", description="Android Tool Suite 插件运行时 CLI")
    commands = root.add_subparsers(dest="command", required=True)

    lint = commands.add_parser("lint", help="validate a 插件运行时 plugin project")
    ...
    verify_command = commands.add_parser("verify", help="verify a 插件运行时 .atsplugin")
